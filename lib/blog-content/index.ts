// Export all blog content functions
export { getBeyondTimesReachContent } from './beyond-times-reach';
export { getTheStoryOfATelephoneContent } from './the-story-of-a-telephone';
