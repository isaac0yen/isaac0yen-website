...
export const blogPosts: BlogPost[] = [

  {
    ...
    content: `<article class="max-w-none text-gray-800 leading-relaxed space-y-6 font-mono">
        <div class="border-4 border-black bg-white p-6">
          <p class="mb-4">&gt; In the midst of dust and old piles of appliances, I lie and wait for my final demise. All the hopes and dreams of my evergreen use—building a family and being with them till the very end—fade away.</p>

          <p class="mb-4">&gt; You see, Jack, my owner, was gifted me by his parents—a red shiny telephone. He had just moved into his own apartment, and everyone was happy. I was installed before the housewarming, and I saw how beautiful love could be: relationships and family spirit. Nothing felt happier.</p>

          <p class="mb-4">&gt; In the midst of all these emotions existed a bond far greater than everyone else's—a bond meant to last a lifetime. With this bond, challenges could be fought, and a lifetime of happiness could be created—or so it seemed.</p>
          ...
          <p class="mb-4">&gt; One day, Jack received a mail. I remember so vividly how his face slowly became numb after reading the letter. Little did I know, that would be the last time I'd see him normal.</p>

          <p class="mb-4">&gt; He reached for me, called his mom, and broke the news.</p>

          <div class="my-6 border-l-4 border-black pl-4 bg-gray-50 p-4">
              <p class="mb-2 font-bold">"Tell Jane," she said.</p>
              <p class="font-bold">"No, it'll break her," he replied. "I'd never want to be the reason why she's sad."</p>
          </div>

          <p class="mb-4">&gt; He placed me back, hanging up the phone, dressed up, and left. I couldn't help but wonder what could be going on in his mind.</p>

          <div class="my-6 border-2 border-black bg-gray-100 p-4">
              <p class="mb-2">// What's he gonna do? Run away?</p>
              <p class="mb-2">// No, he can't. He's way too smart to do that.</p>
              <p class="mb-2">// He must have gone to Jane's place, right?</p>
              <p class="mb-2">// He, of all people, knows the importance of communication, right?</p>
              <p>// ...Right?</p>
          </div>

          <p class="mb-4">&gt; He came back that evening. I couldn't tell if he was drunk or just high on his problems.</p>

          <p class="mb-4">&gt; "There's no way I'm gonna die early, right?" That was exactly my thought. It's just leukemia, right? Wait, what's leukemia?</p>

          <div class="my-6 border-l-4 border-black pl-4 bg-gray-50 p-4">
              <p class="mb-2 font-bold">"I'm gonna have to go away," I heard from his room.</p>
              <p class="text-gray-600">// What?? There's no way you're going away! What's gonna happen to Jane? What's gonna happen the day she finds out? What's gonna happen when every day I ring and she starts getting worried? What's gonna happen if she comes over, sees you're nowhere to be found, tells your mom, and we all panic...</p>
          </div>

          <p class="mb-4">&gt; I've never wished to be audible so much in my life so much. God, if you could, now would be a nice time. Please, this guy's gonna make a mistake.</p>

          <div class="my-6 border-l-4 border-black pl-4 bg-gray-50 p-4">
              <p class="mb-2 font-bold">"I can't let the pity come from different directions," he said. "The day Jane finds out, she's gonna break... and make sure she comes here till the day I die."</p>
              <p class="text-gray-600">// And I'm like, "Die?"</p>
          </div>

          <p class="mb-4">&gt; He looks around, wondering who made that sound.</p>
          <p class="mb-4 text-gray-600">// Did he hear me?</p>

          <p class="mb-4">&gt; "Yes," he continued. "I've been ignorant for too long, and at the brink of time... being diagnosed wrongly for too long. I don't have much time left, and why cause them the stress? Why cause them the pain? I've seen what cancer does to people and families."</p>

          <p class="mb-4 text-gray-600">// And I'm like, "Ooh cancer, that's leukemia."</p>

          <p class="mb-4">&gt; "This is the best thing I have to do..." Then he leaves…</p>

          <p class="mb-4">&gt; Six months later after his eventual demise, everyone's coming to pack his things. The house that once gathered to celebrate a life's beginning has been reduced to memories and sighs.</p>

          <p class="mb-4 text-gray-600">// Sighhh.</p>

          <p class="mb-4 text-gray-600">// If only he knew...</p>

          <p class="mb-4">&gt; That love is called love for a reason, and it's most effective in the dark times. Even when you're lonely, wanting to bear the brunt of your actions, inactions, and the circumstances life throws at you—that's when love prevails.</p>

          <p class="mb-4">&gt; Now, I'm useless, probably going to be given out. But if I could say something to him now that he's gone... Open up to people who care. Communicate when things are tough. You don't have to take it all on your own.</p>
        </div>
        <p class="text-sm text-gray-500 mt-4 font-mono">// Image source: Unsplash.com</p>
        </article>`,
...
<article class="max-w-3xl mx-auto space-y-8 font-mono">
    <section class="mb-12 border-4 border-black bg-white p-6">
        <div class="border-b-4 border-black pb-4 mb-6">
          <h2 class="text-2xl font-bold text-black">&gt; HER_POV</h2>
        </div>
        <div class="text-gray-800 leading-relaxed space-y-4">
            ...
            <p class="border-l-4 border-black pl-4 bg-gray-100 p-3 font-bold">"How long have I been asleep?"</p>
            <p>&gt; I looked so... old.</p>
            ...
            <p class="text-gray-600">// "If only I could remember..."</p>
    ...
    <section class="mb-12 border-4 border-black bg-white p-6">
        <div class="border-b-4 border-black pb-4 mb-6">
          <h2 class="text-2xl font-bold text-black">&gt; HIS_POV</h2>
        </div>
        <div class="text-gray-800 leading-relaxed space-y-4">
