      ...
      <section className="relative pt-32 pb-20">
        <div className="container mx-auto px-4 lg:px-8">
          <div className="text-center mb-16">
            <h1 className="text-5xl lg:text-7xl font-black tracking-tight text-gray-900 mb-6">
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-20">
            ...
            <div className="flex justify-center lg:justify-start">
              <div className="relative group">
                ...
                <div className="absolute -inset-4">
                  <div className="absolute top-0 right-0 w-20 h-20 bg-blue-500 rounded-2xl opacity-20 group-hover:rotate-12 transition-transform duration-500"></div>
                  <div className="absolute bottom-0 left-0 w-16 h-16 bg-purple-500 rounded-xl opacity-20 group-hover:-rotate-12 transition-transform duration-500 delay-100"></div>
                  <div className="absolute top-1/2 -right-8 w-12 h-12 bg-indigo-500 rounded-lg opacity-20 group-hover:translate-x-2 transition-transform duration-500 delay-200"></div>
                </div>
            ...
            <div className="space-y-8">
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                  <Link
                    href="/contact"
                    className="text-blue inline-flex items-center justify-center px-8 py-4 bg-white text-gray-900 rounded-2xl text-lg font-semibold hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 hover:shadow-xl"
                  >
                    Get In Touch
                  </Link>
                </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-20">
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <div className="w-8 h-8 bg-gradient-to-r from-indigo-600 to-blue-600 rounded-lg mr-3"></div>
                Education & Growth
              </h3>
              <p className="text-gray-700 leading-relaxed mb-6">
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20 hover:shadow-2xl transition-all duration-500 hover:scale-[1.02]">
              <h3 className="text-2xl font-bold text-gray-900 mb-6 flex items-center">
                <div className="w-8 h-8 bg-gradient-to-r from-green-600 to-blue-600 rounded-lg mr-3"></div>
                Vision & Impact
              </h3>
              <p className="text-gray-700 leading-relaxed mb-6">
