...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: 'https://isaac0yen.com/assets/me-2.jpeg', sizes: '16x16' },
      { url: 'https://isaac0yen.com/assets/me-2.jpeg', sizes: '32x32' }
    ],
    apple: { url: 'https://isaac0yen.com/assets/me-2.jpeg', sizes: '180x180' },
